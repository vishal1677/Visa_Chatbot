...
import 'package:visachatbot/home/icon_but_with_cnt.dart';

class RecommendSystem extends StatefulWidget {
  const RecommendSystem({Key? key}) : super(key: key);

  @override
  State<RecommendSystem> createState() => _ViewUserReportState();
}

class _ViewUserReportState extends State<RecommendSystem> {
                        ...
                        child: SingleChildScrollView(
                          child: Container(
                            ...
                            child: SingleChildScrollView(
                              child: Padding(
                                padding:
                                    const EdgeInsets.only(left: 15, top: 80.0),
                                child: Column(
